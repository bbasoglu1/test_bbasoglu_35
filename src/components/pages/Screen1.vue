<template>
  <NucGridPage v-bind:gap="{'col':0,'row':0}" v-bind:rows="[1]"
    ...
    v-bind:columns="[1]" overflow="auto" v-bind:designMode="false" v-bind:minNsLimit="1399"
    ...
    <NucGridCell v-bind:wrap="true" v-bind:reverse="false" overflow="hidden" direction="column"
      ...
      <NucGroupElement top="-7.868020304568528%" left="0%" v-bind:snapX="false" v-bind:snapY="true"
        ...
        v-bind:style="{'color':'#FFFFFF','width':'1399.6499999999999px','height':'849.7875px','zIndex':2,'fontSize':'11.25281109375px','maxWidth':'','minWidth':'7.5018740625','tabIndex':'-0.75018740625','boxShadow':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'7.5018740625','textAlign':'center','background':'','fontFamily':'Roboto-Regular,Roboto','fontWeight':'normal','lineHeight':'0.9377342578125','marginLeft':'0px','paddingTop':'','textShadow':'','visibility':'visible','borderColor':'#767676','borderStyle':'solid','marginRight':'0px','paddingLeft':'','marginBottom':'0px','paddingRight':'','paddingBottom':'','borderTopWidth':'0.75018740625px','textDecoration':'none','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'0px','borderTopRightRadius':'0px','borderBottomLeftRadius':'0px','borderBottomRightRadius':'0px'}">
        <WImage top="12.349117920148561%" left="0%" v-bind:blank="false" v-bind:snapX="false" v-bind:snapY="false"
          ...
          v-bind:style="{'width':'700.6750374375001px','height':'590.39748871875px','zIndex':4,'maxWidth':'','minWidth':'','boxShadow':'','marginTop':'0px','maxHeight':'','minHeight':'','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','borderColor':'#4B74FF','borderStyle':'solid','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','borderTopWidth':'0px','borderLeftWidth':'0px','borderRightWidth':'0px','borderBottomWidth':'0px','borderTopLeftRadius':'0px','borderTopRightRadius':'0px','borderBottomLeftRadius':'0px','borderBottomRightRadius':'0px'}"/>
        <WLabel top="16.15668402777778%" left="51.015625%" text="Contact Us" v-bind:snapX="false" v-bind:snapY="false"
          ...
          v-bind:style="{'color':'#000000','width':'','height':'','zIndex':5,'fontSize':'33.75843328125px','maxWidth':'','minWidth':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'normal','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        <WLabel top="24.882075471698112%" left="51.144492131616595%"
          ...
          v-bind:style="{'color':'#000000','width':'349.91249999999997px','height':'19.995px','zIndex':6,'fontSize':'16.5041229375px','maxWidth':'','minWidth':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'normal','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        <WIconButton tag="button" top="31.93069306930693%" icon="fab fa-twitter" left="50.83449235048679%"
          ...
          v-bind:style="{'width':'50.012493750000004px','height':'36.0089955px','zIndex':7,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WIconButton tag="button" top="31.93069306930693%" icon="fab fa-instagram" left="55.21557719054242%"
          ...
          v-bind:style="{'width':'46.011494250000005px','height':'36.0089955px','zIndex':8,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WIconButton tag="button" top="31.524685936843714%" icon="fab fa-pinterest-p" left="59.585121602288986%"
          ...
          v-bind:style="{'width':'41.9895px','height':'35.991px','zIndex':9,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WIconButton tag="button" top="31.447834533196207%" icon="fas fa-basketball-ball" left="63.285714285714285%"
          ...
          v-bind:style="{'width':'53.9865px','height':'42.98925px','zIndex':10,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WEmailInput id="a0f45a87-28a5-4e08-aa08-69b7fc1e0c71" top="45.23003472222222%" v-bind:lazy="false"
          ...
          v-bind:style="{'color':'','width':'291.072713625px','height':'48.76218140625px','zIndex':11,'fontSize':'13.5033733125px','maxWidth':'','minWidth':'118.5296101875px','boxShadow':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'normal','lineHeight':'0.75018740625','marginLeft':'0px','paddingTop':'0px','visibility':'visible','borderColor':'#D1D1D6','borderStyle':'solid','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        <WSquaredSuccessButton tag="button" top="45.69444444444444%" left="73.515625%" v-bind:pill="false" size="md"
          ...
          v-bind:style="{'width':'97.5243628125px','height':'42.76068215625px','zIndex':12,'fontSize':'15.003748125px','maxWidth':'','minWidth':'','tabIndex':'0px','boxShadow':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'center','fontFamily':'OpenSans-Bold,Open Sans','fontWeight':'bold','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'','textShadow':'','visibility':'visible','borderStyle':'solid','marginRight':'0px','paddingLeft':'','marginBottom':'0px','paddingRight':'','paddingBottom':'','borderTopWidth':'1.5003748125px','textDecoration':'none','borderLeftWidth':'1.5003748125px','borderRightWidth':'1.5003748125px','horizontalHeight':'28.158059237371873px','borderBottomWidth':'1.5003748125px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WIconButton tag="button" top="61.705296116690214%" icon="fas fa-map-marker-alt" left="51.144492131616595%"
          ...
          v-bind:style="{'width':'38.990249999999996px','height':'40.98975px','zIndex':13,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WIconButton tag="button" top="61.712239583333336%" icon="fas fa-mobile-alt" left="77.213134765625%"
          ...
          v-bind:style="{'width':'35.25880809375px','height':'40.5101199375px','zIndex':14,'maxWidth':'','minWidth':'11.25281109375px','tabIndex':'0px','boxShadow':'','marginTop':'','maxHeight':'','marginLeft':'','paddingTop':'','visibility':'visible','borderStyle':'none','marginRight':'','paddingLeft':'','marginBottom':'','paddingRight':'','hasDesignMode':true,'paddingBottom':'','borderTopWidth':'0.75018740625px','borderLeftWidth':'0.75018740625px','borderRightWidth':'0.75018740625px','borderBottomWidth':'0.75018740625px','borderTopLeftRadius':'3.000749625px','borderTopRightRadius':'3.000749625px','borderBottomLeftRadius':'3.000749625px','borderBottomRightRadius':'3.000749625px'}"/>
        <WLabel top="68.65668402777777%" left="51.84814453125%" text="Address" v-bind:snapX="false" v-bind:snapY="false"
          ...
          v-bind:style="{'color':'#000000','width':'','height':'','zIndex':15,'fontSize':'18.75468515625px','maxWidth':'','minWidth':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'OpenSans-SemiBold,Open Sans','fontWeight':'normal','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        <WLabel top="68.84114583333333%" left="77.62939453125%" text="Phone" v-bind:snapX="false" v-bind:snapY="false"
          ...
          v-bind:style="{'color':'#000000','width':'','height':'','zIndex':16,'fontSize':'18.75468515625px','maxWidth':'','minWidth':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'OpenSans-SemiBold,Open Sans','fontWeight':'normal','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        <WLabel top="73.82075471698113%" left="51.93133047210301%" text="Sample text. Click to select the text box"
          ...
          v-bind:style="{'color':'#747474','width':'239.94px','height':'33.9915px','zIndex':17,'fontSize':'15.003748125px','maxWidth':'','minWidth':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'normal','lineHeight':'1.05026236875','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','textDecoration':'none'}"/>
        ...
        <WAlert top="23.147058823529413%" v-bind:fade="false" left="15.101190476190476%" v-bind:pill="false"
          ...
          id="2154d396-c3fd-42bf-80ac-375470370293"
          v-bind:style="{'color':'#FFFFFF','width':'','height':'','zIndex':19,'fontSize':'12.007663999999998px','maxWidth':'','minWidth':'','tabIndex':'0px','boxShadow':'','fontStyle':'normal','marginTop':'0px','maxHeight':'','minHeight':'','textAlign':'left','fontFamily':'Roboto-Regular,Roboto','fontWeight':'300.1916','lineHeight':'18.011495999999998px','marginLeft':'0px','paddingTop':'0px','textShadow':'','visibility':'visible','borderColor':'#fff3cd','borderStyle':'none','marginRight':'0px','paddingLeft':'0px','marginBottom':'0px','paddingRight':'0px','paddingBottom':'0px','borderTopWidth':'0px','textDecoration':'none','borderLeftWidth':'0px','borderRightWidth':'0px','horizontalHeight':'','borderBottomWidth':'0px','borderTopLeftRadius':'0px','borderTopRightRadius':'0px','borderBottomLeftRadius':'0px','borderBottomRightRadius':'0px'}"/>
      </NucGroupElement>
    </NucGridCell>
  </NucGridPage>
</template>
